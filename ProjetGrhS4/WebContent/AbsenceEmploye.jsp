	...
	<section id="services" class="section section-padded">
		<div class="container">
			<div class="row title text-center" style="margin-top:150px">
				<h2>Absences</h2>
				<h4 class="light muted">Votre absences</h4>
			</div>
			<div class="row services">
			<c:if test="${absences.size() == 0 }">
			<div class="login-logo">
			<h6 style="font-size:20px;" align="center"><b>Vous n'avez aucune absence :-) .<a style="color:#00A8FF"> cliquez sur la photo pour retourner à l'acceuil .</a></b></h6>
			<div>
			<a href="HomeEmploye.jsp"> <img src="dist/img/pasabsence.jpg" width="842" height="560" style="margin-left:160px; border:solid; border-color:#FBFDFC; box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);"></a></div>
				...
				<div class="col-md-4">
					<div class="service">
						<div class="icon-holder">
							<img src="Cardio/img/icons/heart-blue.png" alt="" class="icon">
						</div>
						
						
						<h4 class="heading">Absence</h4>
						<h5 class="heading">${ab.getDateAbsences() }</h5>
						<p class="description" id="message">Nature : ${ab.getNatureAbsences()}</p>
						<p class="description" id="message">Motif : ${ab.getMotifAbsences()}</p>
						
						
					
					</div>
					<i class="fas fa-bell" id="show-option" onclick="window.location.href='AbsenceDocument?IdAbsence=${ab.getIdAbsences()}'" title="cliquer pour signaler erreur dans ce champs" style="margin-top:-555px;margin-left:170px"></i>
				</div>
