...
<head>
	...
	<title>Gestion des ressources humaines | Profil Admin</title>
	...
	<section id="team" class="section gray-bg">
		<div class="container">
			<div class="row title text-center">
				<h2 class="margin-top">Admin</h2>
				<h4 class="light muted">Information sur l'admin</h4>
			</div>
			<div class="row">
			<div class="col-md-4" style="margin-left:390px">
					<div class="team text-center">
						<div class="cover" style="background:url('Cardio/img/photo1.jpg'); background-size:cover;">
							<div class="overlay text-center">
								<h3 class="white">${ad.emailAdmin}</h3>
								<h5 class="white">${ad.telAdmin}</h5>
							</div>
						</div>
						<img src="data:image/jpeg;base64,${Admin.getPhotoAdmin() }" 
                       onerror="if (this.src != 'dist/img/person.jpg') this.src = 'dist/img/person.jpg';" alt="Team Image" class="avatar" style="box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);">
						<div class="title">
							<h4>${ad.loginAdmin}</h4>
