...
<head>
  ...
  <title>Gestion des ressources humaines | Profile Employer</title>
            ...
            <div class="card card-primary card-outline">
              <div class="card-body box-profile">
                <div class="text-center">
                  ...
                  <a href="dist/img/person.jpg"><img class="profile-user-img img-fluid img-circle"
                       src="dist/img/person.jpg"
                       alt="User profile picture"></a>
                       
                </div>

                <h3 class="profile-username text-center">${ idEmploye.nomEmploye}</h3>

                <p class="text-muted text-center">Employe</p>

                <ul class="list-group list-group-unbordered mb-3">
                  <li class="list-group-item">
                    <b>Email</b> <a class="float-right">${ idEmploye.emailEmploye}</a>
                  </li>
                  <li class="list-group-item">
                    <b>Date de naissance</b> <a class="float-right">${ idEmploye.dateNaissanceEmploye}</a>
                  </li>
                 
                  <li class="list-group-item">
                    <b>Mot de passe</b> <a class="float-right">${ idEmploye.mdpEmploye}</a>
                  </li>
                  <li class="list-group-item">
                    <b>CNI</b> <a class="float-right">${ idEmploye.cniEmploye}</a>
                  </li>
                </ul>
              ...
              <!-- /.card-body -->
               <a class="btn btn-success btn-sm"
											href="AccepterDemande?idEmployesAttente=${idEmploye.getIdEmployesAttente()}" onclick="return confirm('Vous êtes sure ?')"> <i
                 ...
                 <a class="btn btn-danger btn-sm"
											href="DeclinerDemande?idEmployesAttente=${idEmploye.getIdEmployesAttente()}" onclick="return confirm('Vous êtes sure ?')"> <i
