...
<body>
				...
				<div class="header-text">
					<div class="row">
						<div class="col-md-12 text-center">
							<h3 class="light white">Mr/Mdm ${Employe.nomEmploye}.</h3>
							<h1 class="white typed">Bienvenue sur votre plateforme employe.</h1>
	...
	<section>
		...
		<div class="container">
			...
			<div class="col-md-4">
					<div class="intro-table intro-table-hover" style="background-image: url('Cardio/img/photo5.jpg'); box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);">
						<h5 class="white heading hide-hover">Nombre d'absences</h5>
						<div class="bottom">
							<h4 class="white heading small-heading no-margin regular">${nbreAbsence }</h4>
							<h4 class="white heading small-pt">Absence(s)</h4>
							<a href="afficherAbsenceE?nomEmploye=${Employe.nomEmploye }" class="btn btn-white-fill expand">En savoir plus</a>
						</div>
					</div>
				</div>
				<div class="col-md-4">
					<div class="intro-table intro-table-hover" style="background-image: url('Cardio/img/photo4.jpg');">
						<h5 class="white heading hide-hover">Nouveaux messages</h5>
						<div class="bottom">
							<h4 class="white heading small-heading no-margin regular">${nbreNotif }</h4>
							<h4 class="white heading small-pt">Message(s)</h4>
							<a href="MessageEmploye?nomEmploye=${Employe.nomEmploye}" class="btn btn-white-fill expand">en savoir plus</a>
						</div>
					</div>
				</div>
				<div class="col-md-4">
					<div class="intro-table intro-table-hover" style="background-image: url('Cardio/img/photo6.jpg');">
						<h5 class="white heading hide-hover">nombre total des messages</h5>
						<div class="bottom">
							<h4 class="white heading small-heading no-margin regular">${nbreMessage }</h4>
							<h4 class="white heading small-pt">Message(s)</h4>
							<a href="MessageEmploye?nomEmploye=${Employe.nomEmploye}" class="btn btn-white-fill expand">En savoir plus</a>
						</div>
					</div>
