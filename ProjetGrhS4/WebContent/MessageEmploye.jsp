	...
	<section id="services" class="section section-padded">
		<div class="container">
			<div class="row title text-center" style="margin-top:150px">
				<h2>Messages</h2>
				<h4 class="light muted">Votre messages</h4>
			</div>
			<div class="row services">
			<c:if test="${lm.size() == 0 }">
			<div class="login-logo">
			<div>
			<img src="dist/img/rien.jpg" width="242" height="376" style="margin-left:460px"></div>
   <h6 style="font-size:20px;" align="center"><b>Vous n'avez aucun messages .<a href="HomeEmploye.jsp"> cliquez ici pour retourner à l'acceuil .</a></b></h6>
  </div>
			
			</c:if>
			<c:forEach var="lm" items="${lm }"> 
			
				<div class="col-md-4">
					<div class="service" onmouseover="mafonction()">
						<div class="icon-holder">
							<img src="data:image/jpeg;base64,${Admin.getPhotoAdmin() }" onerror="if (this.src != 'dist/img/person.jpg') this.src = 'dist/img/person.jpg';" alt="" class="icon">
						</div>
						
						<h5 class="heading">${Admin.getLoginAdmin() }</h5>
						<h4 class="heading">${lm.sujetMessage}</h4>
						<span class="badge">${lm.notification}</span>
						
						<p class="description" id="message">Envoyé le : ${lm.dateMessage }</p>
					...
					<a class="btn btn-blue"
											href="supprimerMessageE?idMessage=${lm.idMessage}&nomEmploye=${Employe.nomEmploye}" style="margin-left:50px;border-radius: 10px; margin-top:-105px">  Supprimer
										</a>
										<a class="btn btn-blue"
											href="afficherMessageE?idMessage=${lm.idMessage}&nomEmploye=${Employe.nomEmploye}" style="border-radius: 10px; margin-top:-105px">  Voir
										</a>
				...
				var n = msg.length;
				if(n>100){
					document.getElementById("message").innerHTML=msg.slice(0,100)+'...';
				}
			...
			<a class="btn btn-blue" style="border-radius: 12px; margin-left:500px; box-shadow: 0 8px 16px 0 rgba(0,0,0,0.2), 0 6px 20px 0 rgba(0,0,0,0.19);" href="EcrireMessageEmploye.jsp" >Ecrire Message
										</a>
