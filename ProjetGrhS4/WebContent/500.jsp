...
<head>
  ...
  <title>Gestion des Ressources Humaines | Error</title>
    ...
    <section class="content">
      <div class="error-page">
        ...
        <div class="error-content">
          <h3><i class="fas fa-exclamation-triangle text-danger"></i> Oops! Nombre maximal des Employés est atteint.</h3>

          <p>
            Vous avez que 15 postes.
            Vous pouvez <a href="HomeAdmin">retourner a l'acceuil</a> ou voir <a href="listeEmploye">la liste des employés</a>
          </p>
