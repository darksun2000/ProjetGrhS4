...
<head>
  ...
  <title>Gestion des Ressources Humaines | Modifier Absence</title>
        ...
        <div class="row">
          <!-- left column -->
            ...
            <div class="card card-primary" style="margin-left:255px">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form method="post" id="demo-form2" action="modifierAbsence?idAbsence=${absence.getIdAbsences()}" data-parsley-validate>
              <div class="card-body">
              <div class="form-group">
                        <label for="exampleInputEmail1">Nom Employe<span class="required">*</span>
                        </label>
                      
                        <select name="nomEmploye" class="form-control select2" required>
                            <option value="${absence.getNomEmploye()}" selected>${absence.getNomEmploye()}</option>
                      ...
                      <div class="form-group">
                    <label for="exampleInputEmail1">Date d'absence<span class="required">*</span></label>
                    <input type="date" class="form-control" value="${absence.getDateAbsences()}" name="dateAbsence" id="exampleInputEmail1" required="required">
                  </div>
                <div class="form-group">
                  <label>Nature absence<span class="required">*</span></label>
                  <select name="natureAbsence" value="${absence.getNatureAbsences()}" id="nature" onchange="fonctionAbs()" class="form-control select2" style="width: 100%;" required>
                  
                    <option value="${absence.getNatureAbsences()}" selected>${absence.getNatureAbsences()}</option>
                ...
                <div class="form-group">
                  ...
                  <select name="motifAbsence" id="motif" class="form-control select2" style="width: 100%;" required="required">
                  
                    <option value="${absence.getMotifAbsences()}" selected >${absence.getMotifAbsences()}</option>
                            <option>Congé</option>
                ...
                <div class="card-footer">
                  <button type="submit" class="btn btn-primary">Modifier Absence</button>
