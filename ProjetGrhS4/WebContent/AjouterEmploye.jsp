...
<head>
  ...
  <title>Gestion des ressource humaine | Ajouter Employer</title>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="AjouterEmploye.jsp" class="nav-link  active">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Ajouter Employer</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
        ...
        <div class="row">
          <!-- left column -->
            ...
            <div class="card card-primary" style="margin-left:255px">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form" action="ajouterEmploye" method="post">
                <div class="card-body">
                  
                <div class="form-group">
                    <label for="exampleInputEmail1">Nom Employer<span class="required">*</span></label>
                    <input type="text" class="form-control" id="exampleInputEmail1" name="nomEmploye" placeholder="Enter nom" required="required">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1">Email address<span class="required">*</span></label>
                    <input type="email" class="form-control" id="exampleInputEmail1" name="emailEmploye" placeholder="Enter email" required="required">
                  </div>
                  <label for="exampleInputEmail1">Mot de passe<span class="required">*</span></label>
                <div class="input-group mb-3">
                    <input type="password" class="form-control" name="mdpEmploye" id="pswrd" placeholder="Entez mot de passe" required="required">
                    <div class="input-group-prepend">
                    <span class="input-group-text"><i class="fas fa-eye" id="eye" onclick="myfunction()"></i></span>
                  </div>
                  </div>
                  <script>
                  function myfunction(){
                  ...
                  <div class="form-group">
                    <label for="exampleInputEmail1">Date de naissance<span class="required">*</span></label>
                    <input type="date" class="form-control" name="dateNaissanceEmploye" id="exampleInputEmail1" required="required">
                  </div>
                  <div class="form-group">
                  <label>Salaire(Dh)<span class="required">*</span></label>
                  <select name="salaireEmploye" class="form-control select2" style="width: 100%;">
                ...
                <div class="form-group">
                    <label>CNI Employer<span class="required">*</span></label>
                    <input type="text" class="form-control" name="cniEmploye" placeholder="Enter CNI" required="required">
                  </div>
                ...
                <div class="card-footer">
                  <button type="submit" class="btn btn-primary">Ajouter Employer</button>
