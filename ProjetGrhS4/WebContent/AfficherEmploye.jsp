            ...
            <div class="card card-primary card-outline">
              <div class="card-body box-profile">
                <div class="text-center">
                  ...
                  <a href="data:image/jpeg;base64,${idEmploye.photoEmploye }"><img class="profile-user-img img-fluid img-circle"
                ...
                <ul class="list-group list-group-unbordered mb-3">
                  ...
                  <li class="list-group-item">
                    <b>Salaire</b> <a class="float-right">${ idEmploye.salaireEmploye} DHS</a>
                  </li>
                  <li class="list-group-item">
                ...
                <a href="edit?idEmploye=${idEmploye.idEmploye}" class="btn btn-primary btn-block"><b>Modifier</b></a>
              </div>
              <!-- /.card-body -->
            </div>
            <!-- /.card -->
