...
<head>
  ...
  <title>Gestion des Ressources Humaines | Supprimer Ajouterf</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Ajouter/Supprimer Support</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Ajouter/Supprimer Support</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    ...
    <section class="content">
      ...
      <div class="card">
        <div class="card-header">
          <h3 class="card-title">Ajouter/Supprimer Support</h3>
        ...
        <div class="card-body">
           ...
           <div class="col-sm-6">
                      <button type="button" onclick="window.location.href='/ProjetGrhS4/AjouterSuppPage?idcaseTab=${idcaseTab}'" class="btn btn-block btn-outline-success">Ajouter Employe</button>
                    </div>
                    
           <div class="col-sm-6">
                      <button type="button" onclick="window.location.href='/ProjetGrhS4/SupprimerSupp?idcaseTab=${idcaseTab}'" class="btn btn-block btn-outline-danger" id="supprimer">Supprimer Employe</button>
                    </div>
...
<script src="dist/js/demo.js"></script>
                  ...
                  if(${bool}){
                	  document.getElementById('supprimer').className='btn btn-block bg-gradient-danger disabled';
