...
<head>
  ...
  <title>Gestion des ressources humaines | Profile Admin</title>
          ...
          <div class="col-md-7" style="margin-left:220px">
            ...
            <div class="card card-primary card-outline">
              <div class="card-body box-profile">
               ...
               <a href="data:image/jpeg;base64,${Admin.getPhotoAdmin() }">   <img class="profile-user-img img-fluid img-circle"
                ...
                <h3 class="profile-username text-center">${ admin.getLoginAdmin()}</h3>

                <p class="text-muted text-center">Admin</p>

                <ul class="list-group list-group-unbordered mb-3">
                  <li class="list-group-item">
                    <b>Email</b> <a class="float-right">${ admin.getEmailAdmin()}</a>
                  </li>
                  <li class="list-group-item">
                    <b>Mot de passe</b> <a class="float-right">${ admin.getMdpAdmin()}</a>
                  </li>
                  
                  <li class="list-group-item">
                    <b>Numero telephone</b> <a class="float-right">${ admin.getTelAdmin()}</a>
                  </li>
                </ul>

                <a href="editAdmin?loginAdmin=${admin.getLoginAdmin()}" class="btn btn-primary btn-block"><b>Modifier</b></a>
              </div>
              <!-- /.card-body -->
            </div>
            <!-- /.card -->
