...
<title>Gestion des ressources humaines | Liste des absences</title>
...
<img src="dist/img/${messageMetier.getEmployeMessage(msg).getPhotoEmploye() }" onerror="if (this.src != 'dist/img/person.jpg') this.src = 'dist/img/person.jpg';" class="img-circle elevation-2" alt="User Image">
      ...
      <li class="nav-item d-none d-sm-inline-block">
		...
		<aside class="main-sidebar sidebar-dark-danger elevation-4">
			...
			<div class="sidebar">
				...
				<div class="user-panel mt-3 pb-3 mb-3 d-flex">
					<div class="image">
						<img src="data:image/jpeg;base64,${Admin.getPhotoAdmin() }" onerror="if (this.src != 'dist/img/person.jpg') this.src = 'dist/img/person.jpg';" class="img-circle elevation-2"
							alt="User Image">
					</div>
					<div class="info">
		...
		<div class="content-wrapper">
						...
						<table class="table table-striped projects">
							<thead>
								<tr>
									...
									<th style="width: 40%">Nom Employer</th>
									<th style="width: 20%">Nombre d'absence</th>
			...
			<h6 style="font-size:20px;" align="center"><b>Il n'y a aucune absence :-) .<a style="color:#00A8FF" href="HomeAdmin"> cliquez sur la photo pour retourner à l'acceuil .</a></b></h6>
			...
			<tbody>
							<c:forEach var="ab" items="${ absences }">
									...
									<tr>
										...
										<td>${ab.nomEmploye}</td>
										<td>${ab.nbreAbsence }</td>
											<td class="project-actions text-right"><a
											class="btn btn-primary btn-sm"
											href="afficherAbsence?nomEmploye=${ab.nomEmploye}"> <i
		...
		<!-- /.content-wrapper -->
          ...
          <footer class="main-footer">
                    ...
                    <div class="item form-group">
                        ...
                        <a class="btn btn-danger" style="margin-right:50px;margin-left:-180px"
											href="supprimerAbsenceGeneral" onclick="return confirm('Vous êtes sure ?')"> <i
												class="fas fa-trash"> </i> Supprimer Toutes les absences</a>
                          <a href="AjouterAbsence"><button class="btn btn-primary" type="button">ajouter Absence</button></a>
