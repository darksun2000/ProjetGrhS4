...
<head>
  ...
  <title>Gestion De Ressource Humaines | Messages</title>
          ...
          <div class="card card-primary card-outline">
            ...
            <div class="card-body">
                ...
                <thead>
								<tr>
									...
									<th style="width: 35%">Objet du message</th>
									<th style="width: 5%"></th>
                 ...
                 <c:forEach var="msg" items="${messages }" >
                  ...
                  <tr  style="list-style-type:disc;">
                    ...
                    <td class="mailbox-star" onclick="window.location='afficherMessage?idMessage=${msg.idMessage}';"><img 
                    src="data:image/jpeg;base64,${messageMetier.getEmployeMessage(msg).getPhotoEmploye() }" 
                       onerror="if (this.src != 'dist/img/person.jpg') this.src = 'dist/img/person.jpg';"
                     style="border-radius: 8px;" class="img-size-50 img-circle mr-3"></td>
                    <td class="mailbox-name" onclick="window.location='afficherMessage?idMessage=${msg.idMessage}';"><a href="afficherEmployeA?idEmploye=${messageMetier.getEmployeMessage(msg).getIdEmploye()}">${msg.nomEmploye }</a></td>
                    <td onclick="window.location='afficherMessage?idMessage=${msg.idMessage}';" class="mailbox-subject"><b>${msg.sujetMessage }</b>
                    </td>
                    <td onclick="window.location='afficherMessage?idMessage=${msg.idMessage}';" class="mailbox-star"><span class="right badge badge-danger">${msg.notification}</span></td>
                    <td onclick="window.location='afficherMessage?idMessage=${msg.idMessage}';" ><b> <i class="fas fa-clock mr-1"> </i>${msg.dateMessage }</b>
                    </td>
                 <td> 
                 <a class="btn btn-danger btn-sm"
											href="supprimerMessage?idMessage=${msg.idMessage}" onclick="return confirm('Vous êtes sure ?')"> <i
            ...
            <div class="card-footer p-0">
              <div class="mailbox-controls">
                ...
                <a href="ecrireMessage" class="btn btn-primary btn-block mb-3"><i class="fas fa-feather-alt"></i> Ecrire message</a>
                  <a href="supprimerToutMessage" class="btn btn-danger btn-block mb-3"><i class="fas fa-trash"></i> Supprimer touts les messages</a>
