  ...
  <aside class="main-sidebar sidebar-dark-danger elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="ProfilAdmin?loginAdmin=${admin }" class="d-block">${ admin.getLoginAdmin() }</a>
        </div>
      </div>
      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-md-7" style="margin-left:220px">
            ...
            <form method="post" id="demo-form2" action="updateAdmin?ld=${admin.loginAdmin }" data-parsley-validate>
              <div class="card-body box-profile">
              
                <div class="text-center">
                <a href="editphotoA?loginAdmin=${admin.loginAdmin}">
                ...
                <h3 class="profile-username text-center"><input type="text" size="10" class="form-control" style="text-align:center;" value="${ admin.loginAdmin}" name="nomEmploye"></h3>
                ...
                <ul class="list-group list-group-unbordered mb-3">
                  <li class="list-group-item">
                    <b>Email</b> <a class="float-right"><input type="text" size="20"  value="${ admin.emailAdmin}" class="form-control" name="emailEmploye"></a>
                  </li>
                  
                 
                  <li class="list-group-item">
                    <b>Mot de passe</b> <a class="float-right"><input type="text" size="20"  value="${ admin.mdpAdmin}" class="form-control" name="mdpEmploye"></a>
                  </li>
                  <li class="list-group-item">
                    <b>Numero Telephone</b> <a class="float-right"><input type="text" size="20"  value="${ admin.telAdmin}" class="form-control" name="cniEmploye"></a>
                  </li>
                </ul>
