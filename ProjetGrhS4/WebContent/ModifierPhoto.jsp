...
<img src="dist/img/${messageMetier.getEmployeMessage(msg).getPhotoEmploye() }" onerror="if (this.src != 'dist/img/person.jpg') this.src = 'dist/img/person.jpg';" class="img-circle elevation-2" alt="User Image">
          ...
          <a href="listeMessageA" class="dropdown-item dropdown-footer">Voir touts Messages</a>
        </div>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
				...
				<div class="container-fluid">
					<div class="row">
						...
						<div class="card card-primary">
							...
							<!-- /.card-header -->
							<!-- form start -->
							<form role="form" action="modifierphoto?id2=${idEmploye.idEmploye}" method="post" enctype='multipart/form-data'>
								<div class="card-body">

									<label for="exampleInputFile">Photo d'employer</label>
									<div class="custom-file">
										<label for="exampleInputFile">Photo d'employer</label> <input
