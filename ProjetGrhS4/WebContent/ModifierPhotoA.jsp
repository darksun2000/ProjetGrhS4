		...
		<aside class="main-sidebar sidebar-dark-danger elevation-4">
			...
			<div class="sidebar">
				...
				<div class="user-panel mt-3 pb-3 mb-3 d-flex">
					...
					<div class="info">
						<a href="ProfilAdmin?loginAdmin=${admin }" class="d-block">${ admin.loginAdmin }</a>
					</div>
				</div>
               ...
               with font-awesome or any other icon font library -->
						<li class="nav-item active"><a href="HomeAdmin" class="nav-link">
					...
					<div class="row">
						...
						<div class="card card-primary">
							<div class="card-header">
								<h3 class="card-title">Veuillez choisir la photo</h3>
							</div>
							<!-- /.card-header -->
							<!-- form start -->
							<form role="form" action="modifierphotoA?loginAdmin2=${admin.getLoginAdmin()}" method="post" enctype='multipart/form-data'>
								<div class="card-body">

									<label for="exampleInputFile">Photo Admin</label>
									<div class="custom-file">
										<label for="exampleInputFile">Photo Admin</label> <input
											type="file" class="custom-file-input" name="photoEmploye"
											id="customFile" accept="image/*"> <label
											class="custom-file-label" for="customFile">Choisir
											photo</label>
									</div>
