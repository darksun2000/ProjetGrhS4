        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="consempAEPSE" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>EP/SE</p>
                </a>
              </li>
		...
		<tr>
			...
			<tr>
				...
				<td width="100" align="center" style="background-color: #F76308;"><font face="Calibri" size="2"
					color="#000000"><b>${l[8]}</b><b>${caseTab[14].getNomEmploye()}</b></font></td>
				<td width="100" align="center" style="background-color: #CA7826;"><font face="Calibri" size="2"
					color="#000000"><b>${l[5]}</b><b>${caseTab[15].getNomEmploye()}</b></font></td>
				<td width="100" align="center" style="background-color: #F76308;"><font face="Calibri" size="2"
					color="#000000"><b>${l[8]}</b><b>${caseTab[16].getNomEmploye()}</b></font></td>
				<td width="100" align="center" style="background-color: #32C319;"><font face="Calibri" size="2"
					color="#000000"><b> ${l[0]}</b><b>${caseTab[17].getNomEmploye()}</b></font></td>
				<td width="100" align="center" style="background-color: #E5FB05;"><font face="Calibri" size="2"
					color="#000000"><b>${l[3]}</b><b>${caseTab[18].getNomEmploye()}</b></font></td>
				<td width="100" align="center" style="background-color: #F76308;"><font face="Calibri" size="2"
					color="#000000"><b>${l[8]}</b><b>${caseTab[19].getNomEmploye()}</b></font></td>
				<td width="100" align="center" style="background-color: #A2FB05;"><font face="Calibri" size="2"
					color="#000000"><b>${l[2]}</b><b>${caseTab[20].getNomEmploye()}</b></font></td>
				<td width="100" align="center" style="background-color: #32C319;"><font face="Calibri" size="2"
					color="#000000"><b>${l[0]}</b><b>${caseTab[21].getNomEmploye()}</b></font></td>
				<td width="100" align="center" style="background-color: #FFCA8A;"><font face="Calibri" size="2"
					color="#000000"><b>${l[6]}</b><b>${caseTab[22].getNomEmploye()}</b></font></td>
