...
<title>Gestion des ressources humaines | Afficher des absences</title>
...
<img src="dist/img/${messageMetier.getEmployeMessage(msg).getPhotoEmploye() }" onerror="if (this.src != 'dist/img/person.jpg') this.src = 'dist/img/person.jpg';" class="img-circle elevation-2" alt="User Image">
      ...
      <li class="nav-item d-none d-sm-inline-block">
			...
			<section class="content">
				...
				<div class="card">
					<div class="card-header">
						<h3 class="card-title">${nomEmploye}</h3>
						...
						<table class="table table-striped projects">
							<thead>
								<tr>
									...
									<th style="width: 30%">	Date d'absence</th>
									<th style="width: 20%">Motif d'absence</th>
                                     <th style="width: 20%">Nature d'absence</th>
							...
							<c:forEach var="ab" items="${ absences }">
									...
									<tr>
										...
										<td>${ab.getDateAbsences()}</td>
										<td>${ab.getMotifAbsences() }</td>
										<td>${ab.getNatureAbsences() }</td>
											<td class="project-actions text-right">
											<a class="btn btn-primary btn-sm" href="modifierAbsencePage?idAbsence=${ab.getIdAbsences()}" >
											 <i class="fa fa-wrench"> </i> Modifier</a>
											<a class="btn btn-danger btn-sm" href="supprimerAbsence?idAbsence=${ab.getIdAbsences()}" onclick="return confirm('Vous êtes sure ?')">
       ...
       <div class="item form-group">
                        ...
                        <a class="btn btn-danger" style="margin-left:-140px"
											href="supprimerAbsenceEmploye?nomEmploye=${nomEmploye}" onclick="return confirm('Vous êtes sure ?')"> <i
												class="fas fa-trash"> </i> Supprimer Toutes les absences de Mr ${nomEmploye }</a>
